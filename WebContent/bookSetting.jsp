<%@page import="com.zjut.azure2.Book"%>
<%@page import="com.zjut.azure2.Type"%>
						...
						<table id="dynamic-table"
							...
							<thead>
								<tr>
									...
									<th class="center">预订入住时间</th>
									<th class="center">预订退房时间</th>
									<th class="center col-xs-1">预订数量</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="center"><%=booklist.get(i).getNum()%></td>
									<td class="center"><%=booklist.get(i).getType()%></td>
									<td class="center"><%=booklist.get(i).getName()%></td>
									<td class="center"><%=booklist.get(i).getCheckin()%></td>
									<td class="center"><%=booklist.get(i).getCheckout()%></td>
									<th class="center col-xs-1"><%=booklist.get(i).getQuantity()%></th>
									<td>
									...
									<td>
										<div>
											<form class="no-padding" action="bookDelete" method="post"
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body no-padding">
									<tr class="detail-row">
										<form class="form-horizontal" role="form" action="bookAdd"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="订单号" class="col-xs-8"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="date" class="col-xs-8" 
					...
					<%for(int i=0;i<booklist.size();i++){
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body no-padding">
									<tr class="detail-row">
										<form class="form-horizontal" role="form" action="bookChange"
											method="POST" accept-charset="UTF-8">
											<div class="space-6"></div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="订单号" class="col-xs-8"
														required="required" name="num"  value="<%=booklist.get(i).getNum() %>"/>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select name="type" class="col-xs-8" multiple="multiple">
														...
														<option value="<%=typelist.get(j).getType() %>" <%if(booklist.get(i).getType().equals(typelist.get(j).getType())){ %>selected="selected"<%} %>><%=typelist.get(j).getType() %></option>
														<%} %>
													</select>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="姓名" class="col-xs-8"
														required="required" name="name"  value="<%=booklist.get(i).getName() %>"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="date" class="col-xs-8" required="required"
														 name="checkin"  value="<%=booklist.get(i).getCheckin() %>"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="date" class="col-xs-8" required="required"
														 name="checkout"  value="<%=booklist.get(i).getCheckout() %>"/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right">
												...
												<div class="col-sm-9">
													<input type="text" class="col-xs-8" required="required"
														 name="quantity"  value="<%=booklist.get(i).getQuantity() %>"/>
												</div>
											</div>
