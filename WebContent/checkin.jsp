				...
				<div class="page-content">
					...
					<div>
						<table id="dynamic-table"
							...
							<tbody>
								<%
									ArrayList<checkinData> checkinDatas = (ArrayList<checkinData>) request.getAttribute("checkinDatas");
									//System.out.print(roomlist.size());
									for (int i = 0; i < checkinDatas.size(); i++) {
								%>
								<tr>

									<td class="center"><%=checkinDatas.get(i).getNum()%></td>
									<td class="center"><%=checkinDatas.get(i).getType()%></td>
									<td class="center"><%=checkinDatas.get(i).getPrice()%></td>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body no-padding">
									<tr class="detail-row">
										<form class="form-horizontal" role="form" action="checkinSet"
											method="post">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													...
													<input type="text" class="col-xs-8" required="required"
														value="<%=checkinDatas.get(i).getNum()%>"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="客人姓名" class="col-xs-8"
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<select class="col-xs-8" id="form-field-select-1"
														name="idtype">
											...
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input type="text" placeholder="证件号码" class="col-xs-8"
